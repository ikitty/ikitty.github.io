...
function showLayer (id) { showDialog.show({id: id, bgcolor:'#000', opacity:80}); }

//todo
//TJ.loadjs("http://ossweb-img.qq.com/images/js/title.js", function(){
...
TJ(function () {
    TJ('body').addClass('dom_ready');

    //todo 
    //TJ.loadjs("http://tajs.qq.com/stats?sId=30861886", function(){
        //TJ.loadjs("http://pingjs.qq.com/ping_tcss_ied.js",function(){
